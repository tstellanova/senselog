...
const int kErrorLED = 5;
const int kSDChipSelect = 4;
const int kSDStatusLED = 8;
const int kSDCardDetect = 7;
const int kRXLED = 17;  // The RX LED has a defined Arduino pin
...
void setupPinMap() {
  ...
  pinMode(kRXLED, OUTPUT);  // Set RX LED as an output
  digitalWrite(kRXLED, HIGH); //strangely this should turn OFF the RX led
  TXLED1; //turns off the TX LED
